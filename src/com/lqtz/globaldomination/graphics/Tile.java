...
public class Tile extends Object{
	...
	private static final int tileSize = 8;		// Change this to the real value in future
	private static final int maxUnitCapacity = 50;	// Max number of units that can fit on a tile
	
	public Hexagon hexagon;
//	public Unit[] unitsOnTile;		// Uncomment when this exists
//	this.unitsOnTile = new Unit[Tile.maxUnitCapacity];		// Uncomment when this exists
	public int tileRevenue;
	public int tileProductivity;
	public boolean hasCity = false;

	public Tile(int centerX, int centerY, int size, int revenue, int productivity) {
