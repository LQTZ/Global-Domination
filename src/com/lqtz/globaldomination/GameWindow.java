...
public class GameWindow extends JFrame
{
	...
	private JPanel centerPanel;			// Panel with map pane, action buttons pane, and combat info pane
	...
	private void addComponents()
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			buttons[i].setAlignmentX(Component.CENTER_ALIGNMENT);		// Align button
		...
		controlPane.setLayout(new GridBagLayout());		// Change controlPane layout setter to GridBagLayout
		GridBagConstraints controlPanelFormattingConstraints = new GridBagConstraints();	// Object to hold GridBagLayout constraints
		...
		controlPanelFormattingConstraints.gridx = 3;       // Centered (aligned at column 3)
		controlPanelFormattingConstraints.gridwidth = 5;   // 5 columns wide
		controlPanelFormattingConstraints.gridy = 1;       // First row
		controlPane.add(buttonsPane, controlPanelFormattingConstraints);	// Add the buttons pane
		
		// Set up the combat odds label and pane to go below the action buttons
		// TODO Make combat odds panel distributed across the entire center panel
		...
		controlPane.add(combatOddsPane, controlPanelFormattingConstraints);	// Add the combat odds pane
		...
		leftPanel.setBorder(BorderFactory.createLineBorder(Color.black));			// Main panels black
		centerPanel.setBorder(BorderFactory.createLineBorder(Color.black));			//
		infoPanel.setBorder(BorderFactory.createLineBorder(Color.black));			//
		mapPane.setBorder(BorderFactory.createLineBorder(Color.blue));				// Map blue
		unitsPane.setBorder(BorderFactory.createLineBorder(Color.cyan));			// Units pane cyan
		eventLogPane.setBorder(BorderFactory.createLineBorder(Color.pink));		// Event log pane pink
		controlPane.setBorder(BorderFactory.createLineBorder(Color.blue));			// Control pane blue
		buttonsPane.setBorder(BorderFactory.createLineBorder(Color.cyan));			// Buttons pane cyan
		combatOddsPane.setBorder(BorderFactory.createLineBorder(Color.green));	// Combat odds pane green
